        ...
        async function saveNewShowtime() {
            ...
            try {
                ...
                const isOk = response.ok || result.code === 200 || result.success === true;
                ...
                if (isOk) {
                    ...
                    showNotification('Lỗi khi tạo lịch chiếu: ' + (result.message || result.error || 'Unknown error'), 'danger');
                }
            } catch (error) {
            ...
            return dayShowtimes.map(showtime => {
                ...
                return `
                    <div class="calendar-showtime-item" onclick="showShowtimeDetail('${showtime.id}')"
                         ...
                         data-poster="${posterUrl}" title="<img src='${posterUrl}' width='140' height='200' style='object-fit:cover;border-radius:6px;'>">
