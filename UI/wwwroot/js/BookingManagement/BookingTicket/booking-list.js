class BookingListManager {
    ...
    createBookingRow(booking) {
        ...
        return `
            <tr>
                <td>
                    <span class="fw-bold text-primary">${booking.bookingCode
            }</span>
                </td>
                <td>
                    <div>
                        <div class="fw-semibold">${booking.customerName}</div>
                        <small class="text-muted">${booking.customerEmail
            }</small>
                    </div>
                </td>
                ...
                <td>
                    <span class="badge bg-light text-dark">${booking.seatNumbers
            }</span>
                </td>
                <td>
                ...
                <td>
                    <div class="d-flex">
                        <button class="action-btn btn-view" onclick="bookingManager.viewBookingDetail('${booking.id
            }')" title="Xem chi tiết">
        ...
        content.html(`
            <div class="row">
                <div class="col-md-6">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr><td><strong>Mã đặt vé:</strong></td><td>${booking.bookingCode
            }</td></tr>
                ...
                booking.bookingStatus
                        ...
                        <tr><td><strong>Phương thức thanh toán:</strong></td><td>${booking.paymentMethod
            }</td></tr>
                    </table>
                </div>
                <div class="col-md-6">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr><td><strong>Họ tên:</strong></td><td>${booking.customerName
            }</td></tr>
                        <tr><td><strong>Số điện thoại:</strong></td><td>${booking.customerPhone
            }</td></tr>
                        <tr><td><strong>Email:</strong></td><td>${booking.customerEmail
            }</td></tr>
                        ${booking.usedPoints > 0
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr><td><strong>Phim:</strong></td><td>${booking.movieTitle
            }</td></tr>
                        <tr><td><strong>Phòng chiếu:</strong></td><td>${booking.cinemaRoom
            }</td></tr>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-borderless table-sm">
                        <tr><td><strong>Ghế:</strong></td><td>${booking.seatNumbers
            }</td></tr>
