        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            try
            {
                ...
                if (result.Success && result.Data.ValueKind != JsonValueKind.Undefined)
                {
                    ...
                    // Xử lý role để lưu cả dạng số và dạng chuỗi
                    string roleValue = roleProp.ToString();
                    string roleString;
                    
                    // Chuyển đổi từ số sang chuỗi nếu cần
                    switch (roleValue)
                    {
                        case "1":
                            roleString = "Member";
                        ...
                        case "3":
                            ...
                            break;
                        default:
                            roleString = roleValue; // Giữ nguyên nếu đã là chuỗi
                            break;
                    }
                    ...
                    var claims = new List<Claim>
                    {
                        ...
                        new Claim(ClaimTypes.Role, roleString), // Lưu dạng chuỗi (Admin, Staff, Member)
                        new Claim("RoleId", roleValue), // Lưu thêm dạng số (1, 2, 3)
